...
import com.example.chat.fragment.FriendListFragment;
import com.example.chat.fragment.GroupListFragment;
import com.example.chat.fragment.MyInfoFragment;

public class WeChatAdapter extends FragmentPagerAdapter {
    // 碎片页适配器的构造方法，传入碎片管理器
    public WeChatAdapter(FragmentManager fm) {
        super(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
        Log.d("WeChatAdapter", "Fragment count: " + 3);
    }
